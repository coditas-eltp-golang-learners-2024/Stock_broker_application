...
type DeleteWatchListRepository interface {
	DeleteWatchlist(client *gorm.DB, user *models.DeleteWatchlistRequest, userId uint16) error
}
...
func (repository *deleteWatchListRepository) DeleteWatchlist(client *gorm.DB, watchlist *models.DeleteWatchlistRequest, userId uint16) error {
